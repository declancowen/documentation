...
| `name` | TEXT | Required |
| `description` | TEXT | Optional |
| `cover_recipe_id` | UUID | Cover image source |
...
| View | Purpose |
|------|---------|
| `recipe_with_stats` | Recipes joined with author info (`author_username`, `author_avatar`, `author_first_name`, `author_surname`) and `favorite_count`, `comment_count`, `repost_count` |
| `collection_with_stats` | Collections with author info, `favorite_count`, `item_count`, `repost_count`, `is_public` |
| `post_with_stats` | Posts with author info, `favorite_count`, `comment_count`, `repost_count` |
| `profile_stats` | Profiles with `follower_count`, `following_count`, `recipe_count`, `collection_count`, `post_count`, `total_recipe_likes`, `total_collection_likes`, `total_post_likes` |
